...
import com.example.ung_dung_thuong_mai_dien_tu.adapter.TabletAdapter;
    ...
    private void loadMore() {
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                adaptertablet.notifyItemInserted(sanPhamMoiList.size() - 1);
            }
        });
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                adaptertablet.notifyItemRemoved(sanPhamMoiList.size());
                page  = page +1;
                Getdata(page);
...
//                isLoading = false;
                        ...
                        SpMoiModel -> {
                            if(SpMoiModel.isSuccess()){
                                if(adaptertablet == null){
                                    ...
                                    adaptertablet = new TabletAdapter(getApplicationContext(),sanPhamMoiList);
                                    recyclerView.setAdapter(adaptertablet);
                                }else {
                                    ...
                                    adaptertablet.notifyItemRangeInserted(vitri,soluongadd);
                                }
                                isLoading = false;
    ...
    private void ActionToolbar() {
        ...
        toolbar.setNavigationOnClickListener(v -> {
            Intent intent = new Intent(TabletActivity.this, MainActivity.class);
