                        ...
                        spMoiModel -> {
                            if (spMoiModel.isSuccess()) {
                                if (adapter == null) {
                                    ...
                                    adapter = new PCAdapter(getApplicationContext(), spMoiList);
                                ...
                                isLoading = false;
                                Log.d("PCActivity", "isLoading: " + isLoading);
                            } else {
                                Toast.makeText(getApplicationContext(), "Đã hết sản phẩm", Toast.LENGTH_SHORT).show();
                                isLoading = true;
                                Log.d("PCActivity", "Hết dữ liệu - isLoading: " + isLoading);
                            }
                        },
                        throwable -> {
                            Toast.makeText(getApplicationContext(), "Không kết nối được với server: " + throwable.getMessage(), Toast.LENGTH_LONG).show();
                            isLoading = false;
                            Log.e("PCActivity", "Error: " + throwable.getMessage());
                        }
                ));
    }
