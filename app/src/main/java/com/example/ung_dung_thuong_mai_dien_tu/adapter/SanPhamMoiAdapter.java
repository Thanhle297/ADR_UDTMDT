...
public class SanPhamMoiAdapter  extends RecyclerView.Adapter<SanPhamMoiAdapter.MyViewHolder> {
    ...
    public SanPhamMoiAdapter(Context context, List<SpMoi> array) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.txt_gia.setText("Giá: " +decimalFormat.format(sanPhamMoi.getGiasp()) + " VNĐ");
        ...
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onClick(View view, int pos, boolean isLongClick) {
                if(!isLongClick){
                    ...
                    // Gửi toàn bộ dữ liệu sản phẩm sang trang chi tiết
                    intent.putExtra("chitiet", sanPhamMoi);

                    // Gửi thêm nguồn gọi để biết quay lại đâu
                    intent.putExtra("from", "main"); // hoặc "dien_thoai" nếu adapter dùng cho trang điện thoại
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            txt_gia = itemView.findViewById(R.id.itemsp_price);
            txt_ten = itemView.findViewById(R.id.itemsp_name);
