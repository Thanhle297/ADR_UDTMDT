...
public class PCAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PCAdapter(Context context, List<SpMoi> array) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            tensp = itemView.findViewById(R.id.itempc_tensp);
            giasp = itemView.findViewById(R.id.itempc_giasp);
            motasp = itemView.findViewById(R.id.itempc_motasp);
            hinhanh = itemView.findViewById(R.id.itempc_image);
