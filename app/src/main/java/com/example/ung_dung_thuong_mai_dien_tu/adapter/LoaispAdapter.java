...
public class LoaispAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null){
            ...
            view = layoutInflater.inflate(R.layout.item_sp,viewGroup,false);
            viewHolder.textsanpham = view.findViewById(R.id.item_tensp);
        ...
        viewHolder.textsanpham.setText(array.get(i).getTensanpham());
