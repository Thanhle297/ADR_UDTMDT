...
public class MayTinhBangAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final Context context;
    private final List<SpMoi> array;
    private static final int VIEW_TYPE_DATA = 0;
    private static final int VIEW_TYPE_LOADING = 1;

    public MayTinhBangAdapter(Context context, List<SpMoi> array) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_DATA) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_maytinhbang, parent, false);
            ...
            if (sanPhamMoi != null) {
                ...
                myViewHolder.setItemClickListener((view, pos, isLongClick) -> {
                    if (!isLongClick) {
                        ...
                        intent.putExtra("from", "may_tinh_bang");
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            tensp = itemView.findViewById(R.id.itemmtb_tensp);
            giasp = itemView.findViewById(R.id.itemmtb_giasp);
            motasp = itemView.findViewById(R.id.itemmtb_motasp);
            hinhanh = itemView.findViewById(R.id.itemmtb_image);
